...
module.exports = function(knex, Promise) {
  return Promise.all([
    knex("resources").insert([
      ...
      {
        url:          "https://www.sitepoint.com/10-essential-sublime-text-plugins-full-stack-developer/",
      ...
      {
        url:          "https://www.smashingmagazine.com/2008/11/12-principles-for-keeping-your-code-clean/",
